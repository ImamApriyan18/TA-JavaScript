...
function checkBMI(weight, height) {
    ...
    } else if (18.5 < checkBMI && checkBMI < 24.9) {
        console.log('normal');
    } else if (25 < checkBMI && checkBMI < 29.9) {
        console.log('over weight');
    } else if (30 < checkBMI && checkBMI < 34.9) {
        console.log('obese');
    } else if (35 < checkBMI) {
...
function convToUpperCase(sentence) {
  return sentence.replace (/\w\S*/g, function(text) { return text.charAt(0).toUpperCase() + text.substr(1).toLowerCase()}
  );
